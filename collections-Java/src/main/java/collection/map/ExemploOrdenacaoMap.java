...
public class ExemploOrdenacaoMap {
    public static void main(String[] args) {
        ...
        Map< String, Livro> meusLivros = new HashMap<String, Livro>(){{
            put("Hawking, Stephen", new Livro("Uma Breve História do Tempo", 500));
            put("Duhigg, Charles", new Livro("O Poder do Hábito", 450));
            put("Harari, Yuval Noah", new Livro("21 Lições Para o Século 21", 300));
        }};
...
//
        ...
        Set<Map.Entry<String, Livro>> meusLivros3 = new TreeSet<Map.Entry<String, Livro>> (new Livro.ComparatorNome());
        ...
        Set<Map.Entry<String, Livro>> meusLivros4 = new TreeSet<Map.Entry<String, Livro>> ( new ComparatorPaginas());
