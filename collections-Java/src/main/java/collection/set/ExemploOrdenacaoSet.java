...
public class ExemploOrdenacaoSet {
    public static void main(String[] args) {
        ...
        Set<Serie> minhasSeries = new HashSet<Serie>(){{
           ...
           add(new Serie( "that '70s dhow", "comédia", 25));
        }};
        ...
        Set<Serie> minhasSeries3 = new TreeSet<Serie>(new ComparatoNomeGeneroTempoEpisodio());
...
class Serie implements Comparable<Serie>{
    ...
    public boolean equals(Object o) {
        ...
        return nome.equals( serie.nome) &&
                ...
                tempoEpsodio.equals(serie.tempoEpsodio);
    }
